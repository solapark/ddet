...
save_dir = '/data3/sap/VEDet/result/tmvreid_messytable_rpn/16_ep2'
bands, max_freq = 64, 8
num_views = 3
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_rpn=dict(type='TripletLoss', use_sigmoid=True, loss_weight=2.0/5),
    ),
    ...
    train_cfg=dict(
        pts=dict(
            ...
            rpn_assigner=dict(
                type='RpnAssigner',
                rpn_cost=dict(type='RpnCost', num_views=num_views),
                pos_thresh=.85,
                neg_thresh=.3))))
...
load_from = 'work_dirs/tmvreid_messytable_rpn16/epoch_1.pth'
resume_from = None
