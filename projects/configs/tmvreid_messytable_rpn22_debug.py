...
save_dir = '/data3/sap/VEDet/result/tmvreid_messytable_rpn/22_debug'
bands, max_freq = 64, 8
num_views = 3
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_cross_attn_map=dict(type='L1Loss', loss_weight=2.0),
    ),
...
load_from = 'work_dirs/tmvreid_messytable_rpn22/epoch_2.pth'
resume_from = None
