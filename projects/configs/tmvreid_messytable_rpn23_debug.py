...
save_dir = '/data3/sap/VEDet/result/tmvreid_messytable_rpn/23_ep40'
bands, max_freq = 64, 8
num_views = 3
...
total_epochs = 200
evaluation = dict(interval=2, pipeline=test_pipeline, metric=['bbox'], show=True, eval_thresh=.1, visible_thresh=.5, reid_thresh=.1, save_dir=save_dir, img_root='/data1/sap/MessyTable/images/', show_query=True)
...
load_from = 'work_dirs/tmvreid_messytable_rpn23/epoch_2.pth'
resume_from = None
