...
save_dir = '/data3/sap/VEDet/result/tmvreid_messytable_rpn/25_ep80'
bands, max_freq = 64, 8
num_views = 3
...
save_reid_pickle = dict(visible_thresh=.5, out_dir='/data3/sap/frcnn_keras_original/pickle/messytable/tmvreid_messytable_rpn25/reid_output/train')
