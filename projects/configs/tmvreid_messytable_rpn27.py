...
save_dir = '/data3/sap/VEDet/result/tmvreid_messytable_rpn/27'
num_query=900
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        dict(type='TMVReidMultiheadCrossAttention', embed_dims=256, num_heads=8, dropout=0.1,
                            attention=dict(type='MultiheadSuperAttention', other_view_wgt=2., num_views=num_views, num_query=num_query, num_key=num_rpn_per_view, top_simK=1)
                        ),
                    ],
...
total_epochs = 200
evaluation = dict(interval=10, pipeline=test_pipeline, metric=['bbox'], show=False, eval_thresh=.1, visible_thresh=.5, reid_thresh=.1, save_dir=save_dir, img_root='/data1/sap/MessyTable/images/', reid_config_dir='/home/sap/VEDet/asnet_config', gt_path='/data1/sap/MessyTable/labels/val.json')
