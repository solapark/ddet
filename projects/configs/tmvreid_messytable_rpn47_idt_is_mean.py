...
save_dir = '/home/sapark/ddet/result/tmvreid_messytable_rpn47_idt_is_mean'
        ...
        det_transformer=dict(
            ...
            det_decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(type='TMVReidMultiheadCrossAttention', embed_dims=256, num_heads=8, dropout=0.1, num_views=3, idt_is_mean=True,
