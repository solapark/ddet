...
save_dir = '/home/sapark/VEDet/result/tmvreid_messytable_rpn57'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_pos=dict(type='PosLoss', alpha=.2, loss_weight=2.0, valid_cost=.6, pos_thresh=15, neg_thresh=100),
    ),
