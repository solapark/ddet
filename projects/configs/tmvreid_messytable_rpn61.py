...
save_dir = '/home/sapark/VEDet/result/tmvreid_messytable_rpn61'
...
model = dict(
    ...
    pts_bbox_head=dict(
        type='TMVReidHead',
        visible_is_attn=True,
        visible_is_attn_mean=True,
        idx_is_attn_org=True, 
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(type='TMVReidMultiheadCrossAttention', embed_dims=256, num_heads=8, dropout=0.1,
                            attention=dict(type='MultiheadSVAttention', num_views=num_views, num_query=num_query, num_key=num_rpn_per_view, scale_dot_type='wgt_mean', return_attn_org=True)),
                        dict(type='TMVReidMultiheadCrossAttention', embed_dims=256, num_heads=8, dropout=0.1,
                            attention=dict(type='MultiheadMVAttention', num_views=num_views, num_query=num_query, num_key=num_rpn_per_view, scale_dot_type='wgt_mean', return_attn_org=True)),
                    ],
