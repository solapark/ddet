    ...
    train_cfg=dict(
        pts=dict(
            ...
            assigner=dict(
                ...
                iou_cost=dict(type='BBoxMtv2DIoUCost', weight=1.0, pred_size=pred_size, num_views=num_views),  # Fake cost. This is just to make it compatible with DETR head. 
...
train_pipeline = [
    ...
    dict(type='ResizeMultiview3D', num_views=num_views, img_scale=(1080, 1920), ratio_range =[.6, .6]),
...
total_epochs = 200
save_dir = '/data3/sap/VEDet/result/messytable10_debug'
...
load_from = 'work_dirs/vedet_messytable12/epoch_160.pth'
#load_from = 'work_dirs/vedet_messytable11/epoch_40.pth'
resume_from = None
