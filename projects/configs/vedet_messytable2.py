...
total_epochs = 24
evaluation = dict(interval=2, pipeline=test_pipeline, metric=['bbox'], show=False, eval_thresh=0, out_dir='/data3/sap/VEDet/result', img_root='/data1/sap/MessyTable/images/', show_gt=False)
...
#load_from = 'work_dirs/vedet_messytable2/epoch_4.pth'
resume_from = None
