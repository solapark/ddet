...
total_epochs = 100
evaluation = dict(interval=2, pipeline=test_pipeline, metric=['bbox'], show=False, eval_thresh=.1, out_dir='/data3/sap/VEDet/result', img_root='/data1/sap/MessyTable/images/')
