...
total_epochs = 100
evaluation = dict(interval=2, pipeline=test_pipeline, metric=['bbox'], show=True, eval_thresh=eval_thresh, out_dir='/data3/sap/VEDet/result', img_root='/data1/sap/MessyTable/images/')
...
load_from = 'work_dirs/vedet_messytable3/epoch_100.pth'
resume_from = None
