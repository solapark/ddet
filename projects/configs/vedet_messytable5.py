...
total_epochs = 200
evaluation = dict(interval=10, pipeline=test_pipeline, metric=['bbox'], show=False, eval_thresh=.1, out_dir='/data3/sap/VEDet/result', img_root='/data1/sap/MessyTable/images/')
