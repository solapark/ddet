...
total_epochs = 200
evaluation = dict(interval=10, pipeline=test_pipeline, metric=['bbox'], show=True, eval_thresh=.2, save_dir='/data3/sap/VEDet/result/messytable5', img_root='/data1/sap/MessyTable/images/')
