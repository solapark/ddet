...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_bbox=dict(type='L1Loss', loss_weight=0.25/50/2),
...
train_pipeline = [
    ...
    dict(type='ResizeMultiview3D', num_views=num_views, img_scale=(1080, 1920), ratio_range =[.35, .35]),
...
total_epochs = 200
save_dir = '/data3/sap/VEDet/result/messytable6'
evaluation = dict(interval=10, pipeline=test_pipeline, metric=['bbox'], show=True, eval_thresh=.1, save_dir=save_dir, img_root='/data1/sap/MessyTable/images/')
