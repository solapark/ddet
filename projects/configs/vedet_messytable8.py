...
total_epochs = 200
save_dir = '/data3/sap/VEDet/result/messytable8'
evaluation = dict(interval=1, pipeline=test_pipeline, metric=['bbox'], show=False, eval_thresh=.1, save_dir=save_dir, img_root='/data1/sap/MessyTable/images/')
