...
class TMVReid(VEDet):
    ...
    def simple_test_pts(self, x, img_metas):
        ...
        if outs.get('all_cls_scores', None) is not None:
            ...
            bbox_results = [bboxmtvreid2result(bboxes, visibles, reid_scores, cls_scores, view_cls_scores, idx_scores, labels, view_labels, query2ds) for bboxes, visibles, reid_scores, cls_scores, view_cls_scores, idx_scores, labels, view_labels, query2ds in bbox_list] 
